...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate, UIDataSourceModelAssociation {
    ...
    override func decodeRestorableState(with coder: NSCoder) {
        ...
        detailViewController = coder.decodeObject(of: DetailViewController.self, forKey: "DetailViewController")
    }
    
    // MARK: - Model Association
    ...
    func indexPathForElement(withModelIdentifier identifier: String, in view: UIView) -> IndexPath? {
        ...
        let object = try? context.existingObject(with: objectID) as? Event,
        let idx = fetchedResultsController.indexPath(forObject: object ) else{
            return nil;
        }
        return idx
    }
